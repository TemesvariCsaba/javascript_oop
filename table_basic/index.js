...
class ColSpanTable extends Table{
    ...
    /**
     * 
     * @param {ColspanRowType[]} e 
     */
    render(e){
            renderColspanBody(this.tbody, e)
    }
}
class RowSpanTable extends Table{
    ...
    /**
     * 
     * @param {RowspanRowType[]} e 
     */
    render(e){
        renderRowspanBody(this.tbody, e)
    }
}
...
button.addEventListener("click", OnButtonClick.bind(rowspan))

/**
 * @this {RowSpanTable} ez az a peldany amivel meghivjuk a rowspanra a metodust
 */
